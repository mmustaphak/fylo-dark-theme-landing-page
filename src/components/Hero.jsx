...
const Hero = () => {
    return (
        <main className="bg-intro bg-mobile-curve bg-no-repeat bg-[center_60%] bg-contain pt-6 md:bg-desktop-curve lg:bg-bottom">
            <img src={illustrationIntro} className="max-w-[20rem] mx-auto" alt="" />
            <h1 className="max-w-[20rem] mx-auto text-center font-raleway text-white text-2xl font-bold lg:mt-4">All your files in one secure locations, accessible anywhere.</h1>
            <div className="mt-4 text-white text-center bg-main lg:bg-transparent">
